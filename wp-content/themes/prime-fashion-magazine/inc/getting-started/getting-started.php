...
function prime_fashion_magazine_getting_started_page(){ ?>
	<div class="wrap getting-started">
		...
		<div class="intro-wrap">
			<div class="intro">
				<h3><?php echo esc_html( 'Getting started with', 'prime-fashion-magazine' );?> <span class="theme-name"><?php echo esc_html( PRIME_FASHION_MAGAZINE_THEME_NAME ); ?></span> <span  class="theme-name">v<?php echo esc_html( PRIME_FASHION_MAGAZINE_THEME_VERSION ); ?></span> </h3>

                <span><?php ?></span>
				<h4><?php printf( esc_html__( 'You will find everything you need to get started with %1$s below.', 'prime-fashion-magazine' ), PRIME_FASHION_MAGAZINE_THEME_NAME ); ?></h4>
			</div>
		</div>
