...
function shopfront_ecommerce_custom_styles($custom) {
	//Fonts
	...
	wp_add_inline_style( 'shopfront-ecommerce-style', $custom );
}
add_action( 'wp_enqueue_scripts', 'shopfront_ecommerce_custom_styles' );

//Sanitizes Fonts
function shopfront_ecommerce_sanitize_fonts( $input ) {
	$valid = array(
